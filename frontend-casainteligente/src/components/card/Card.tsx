...
export function Card({ habitacion }: CardProps) {
    return (
        <div className="rounded-lg border shadow-sm overflow-hidden w-48 overflow-y-auto">
            <div className="p-2 flex justify-center bg-blue-600 text-white">
                <span>{habitacion.nombre}</span>
            </div>
            <div className="flex justify-between p-2 border-b text-slate-600">
